$(function(){var body=$('body');var navbarCollapse=$('.navbar-collapse');body.append('<div class="side-menu-overlay"></div>');var overlay=$('.side-menu-overlay');body.append('<div id="side-menu"></div>');var sideMenu=$('#side-menu');sideMenu.append('<button id="menu-close" class="close"><span aria-hidden="true">×</span></button>')
